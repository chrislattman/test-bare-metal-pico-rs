...
Note: this example does NOT work for the Raspberry Pi Pico 2 W, as that on-board LED is accessed through the CYW43439 Wi-Fi/Bluetooth chip. Also `rp-hal` does not yet support the Pico 2 W.
